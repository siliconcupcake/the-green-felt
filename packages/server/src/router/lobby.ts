...
export const lobbyRouter = router({
  ...
  createRoom: publicProcedure.input(z.object({ gameId: z.string(), playerName: z.string() })).mutation(({ input }) => {
  ...
  joinRoom: publicProcedure.input(z.object({ roomId: z.string(), playerName: z.string() })).mutation(({ input }) => {
    // TODO: Implement
    void input;
    throw new Error('Not yet implemented');
  }),
